...
/mob/living/carbon/human/proc/can_piggyback(mob/living/carbon/target)
	return (istype(target) && !IS_UNCONSCIOUS_OR_CRIT(target) && !HAS_TRAIT(target, TRAIT_PINNED)) // OCULIS EDIT, ORIGINAL: return (istype(target) && !IS_UNCONSCIOUS_OR_CRIT(target))
