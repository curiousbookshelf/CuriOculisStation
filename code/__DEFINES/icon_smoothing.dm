...
#define SMOOTH_GROUP_CARPET_GRIMEY S_TURF(95) // OCULIS EDIT ADDITION

#define MAX_S_TURF 95 // OCULIS EDIT CHANGE - ORIGINAL: #define MAX_S_TURF 94 //Always match this value with the one above it.
