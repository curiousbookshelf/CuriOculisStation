...
/obj/effect/mob_spawn/ghost_role/human/lostcargo
	...
	icon_state = "sleeper"
	mob_species = /datum/species/human
	you_are_text = "You are a deckhand working on a Bristol-class freighter, lumbering through Eidolon." // OCULIS EDIT
...
/obj/effect/mob_spawn/ghost_role/human/lostminer
	...
	icon_state = "sleeper"
	mob_species = /datum/species/human
	you_are_text = "You are an excavator working on a Bristol-class freighter, lumbering through Eidolon." // OCULIS EDIT
...
/obj/effect/mob_spawn/ghost_role/human/lostcargoqm
	...
	icon_state = "sleeper"
	mob_species = /datum/species/human
	you_are_text = "You are the commanding officer of a Bristol-class freighter, lumbering through Eidolon." // OCULIS EDIT
	...
	important_text = "Do not abandon your crew, and don't risk incurring the wrath of any of the larger players in Eidolon." // OCULIS EDIT
	allow_custom_character = GHOSTROLE_TAKE_PREFS_APPEARANCE
	quirks_enabled = TRUE
	loadout_enabled = TRUE
